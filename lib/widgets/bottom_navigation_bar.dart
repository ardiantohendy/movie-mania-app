...
class BottomNavigationBarMovies extends StatefulWidget {
  const BottomNavigationBarMovies({super.key});

  @override
  State<BottomNavigationBarMovies> createState() =>
      _BottomNavigationBarMoviesState();
}

class _BottomNavigationBarMoviesState extends State<BottomNavigationBarMovies> {
